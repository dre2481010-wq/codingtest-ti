...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Tersedia      : 4 eksemplar | Status: Terbatas ⚠️");
        System.out.println("--------------------------------------------");
        ...
        System.out.println("Tersedia      : 3 eksemplar | Status: Terbatas ⚠️");
        System.out.println("--------------------------------------------");
        ...
        System.out.println("[TRX003] SELESAI - TERLAMBAT ⚠️");
